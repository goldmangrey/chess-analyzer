...
def run_local_analysis(game_id: int, stockfish_factory, *, session_factory=SessionLocal) -> None:
...
class LocalAnalysisQueue:
    def __init__(self, background_tasks: BackgroundTasks, stockfish_factory, *, session_factory=SessionLocal):
